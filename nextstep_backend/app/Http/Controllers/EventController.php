...
class EventController extends Controller
{
     ...
     */
    public function registerUser(Request $request, $eventId)
    {
        $validator = Validator::make($request->all(), [
            'user_id' => 'required|exists:users,id',
            'status' => 'sometimes|string|in:registered,attended,cancelled'
        ]);
        ...
        try {
            ...
            $event->registeredUsers()->attach($request->user_id, [
    ...
    {
        try {
            $event = Event::with('registeredUsers')->findOrFail($eventId);
